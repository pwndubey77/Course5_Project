...
public class AnswerController {
    ...
    public ResponseEntity<?> getAllAnswersByLikes(@RequestParam("questionId") int questionId,HttpSession session) {
        ...
        if (session.getAttribute("currUser")==null) {
            ...
            String userId=session.getAttribute("currUser").toString();
            return new ResponseEntity<>(answerService.getAllAnswersByLikes(questionId,userService.getUserID(userId)), HttpStatus.OK);
        }
    }
